...
import 'package:plane_startup/repository/dashboard_service.dart';
import 'package:plane_startup/screens/MainScreens/Home/dash_board_screen.dart';
...
void main() {
  ...
  testWidgets('Integration', (tester) async {
    ...
    when(() => mockWorkspaceProvider.selectWorkspace(id: any(named: "id")))
